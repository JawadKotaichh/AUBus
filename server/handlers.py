...
def handle_update_profile(
    ...
    allowed_fields = ["username", "email", "password", "schedule", "user_id"]
    modifications = {
        "username": update_username(
            user_id=payload["user_id"], new_username=payload["username"]
        ),
        "email": update_email(user_id=payload["user_id"], new_email=payload["email"]),
    ...
    if not fields:
        return _error_server("No fields to update in update payload")
